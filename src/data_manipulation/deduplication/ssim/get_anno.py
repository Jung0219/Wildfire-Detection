...
if __name__ == "__main__":
    ...
    subset_img_dir = "/lab/projects/fire_smoke_awr/data/original/FlameVision/deduplicated/phash20+ssim0.6/images"
    dest_anno_dir = "/lab/projects/fire_smoke_awr/data/original/FlameVision/deduplicated/phash20+ssim0.6/annotations_yolo"
    full_anno_dir = "/lab/projects/fire_smoke_awr/data/original/FlameVision/original/annotations_yolo"
    annotation_ext = "txt"  # Change to "txt" for YOLO labels
