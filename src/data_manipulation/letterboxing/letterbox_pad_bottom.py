...
# --------------------- CONFIGURATION ---------------------
PARENT_DIR = "/lab/projects/fire_smoke_awr/data/final/test_data/small_object_set/original"  # contains images/ and labels/
OUTPUT_DIR = "/lab/projects/fire_smoke_awr/data/final/test_data/small_object_set/original_letterbox_pad_bottom"
IMG_SIZE = 640
STRIDE = 32
PADDING_COLOR = (114, 114, 114)
# ---------------------------------------------------------

def letterbox_bottom(img, new_shape=(640, 640), color=(114, 114, 114), scaleup=True):
    ...
    # Apply vertical padding only on bottom, horizontal padding centered
    top = 0
    bottom = dh
    left = dw // 2
    right = dw - left
    ...
    return img, r, dw, dh  # dw is total width padding, dh is total bottom padding
...
def adjust_yolo_labels(label_path, out_label_path, r, dw, dh, orig_w, orig_h, img_size=640):
    ...
    for line in lines:
        ...
        y = y * r           # vertical padding only on bottom
        w *= r
        h *= r
...
def process_dataset_with_labels(parent_dir, output_dir, img_size=640, padding_color=(114, 114, 114)):
    ...
    for img_path in image_files:
        ...
        img_lb, r, dw, dh = letterbox_bottom(img, new_shape=(img_size, img_size), color=padding_color, scaleup=True)
