...
def main() -> None:
    ...
    print(
        f"Gating counts -> dropped_low: {counts['dropped_low']}, "
        f"auto_kept_high: {counts['auto_kept_high']}, "
        f"sent_to_classifier: {counts['sent_to_classifier']}, "
        f"kept_after_classifier: {counts['kept_after_classifier']}"
    )
