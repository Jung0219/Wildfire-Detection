...
# ================= CONFIG =================
GT_DIR      = "/lab/projects/fire_smoke_awr/data/detection/training/ABCDE_noEF"
PARENT_DIR  = "/lab/projects/fire_smoke_awr/outputs/yolo/detection/ABCDE_noEF/inference_train_data"
YOLO_MODEL  = "/lab/projects/fire_smoke_awr/outputs/yolo/detection/ABCDE_noEF/train/weights/best.pt"

## best values 
INTERMEDIATE_SIZE = 780
NMS_IOU_THRESH = 0.45      # final NMS IoU threshold, None for No NMS

SAVE_IMG = False

# ==========================================
IMAGE_DIR = os.path.join(GT_DIR, "images/train")
