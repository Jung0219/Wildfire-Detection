...
# =========================
CONFIG = {
    "json_file": "/lab/projects/fire_smoke_awr/outputs/yolo/classification/AD_phash3_early_smoke/test/preds.json",  # Path to predictions JSON
    "gt_dir": "/lab/projects/fire_smoke_awr/data/classification/training/AD_phash3_early_smoke/test",          # Ground truth folder (organized by class)
