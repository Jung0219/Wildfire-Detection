...
GT_DIR: str = "/lab/projects/fire_smoke_awr/data/detection/training/ABCDE_all/ABCDE_all_gt_1080/split"     # contains images/test and labels/test
PRED_DIR: str = "/lab/projects/fire_smoke_awr/outputs/yolo/detection/resolution_difference/1080/test/labels" 
