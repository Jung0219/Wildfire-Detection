...
CB_MIN = 120         # Minimum Cb value for boundary
CB_MAX = 255        # Maximum Cb value for boundary
CR_MIN = 0          # Minimum Cr value for boundary
CR_MAX = 130         # Maximum Cr value for boundary
SAVE_PATH = "/lab/projects/fire_smoke_awr/src/.pipeline_old/sky_logic/sky/plane.png"     # e.g., "ycbcr_plane.png" or None to skip saving
# =====================================================
